<?php
    ...
    $getOrderData       =           mysqli_query( $connect, 'SELECT     GatewayPayments.*,
                                                             ...
                                                             WHERE      GatewayPayments.PaymentGUID      =   "'. $_GET['ReceiptID'] .'" 
                                                            ');
            ...
            <tr>
                <td align="center">
                    <table align="center" border="0" cellpadding="2" cellspacing="2" width="100%">
                        ...
                        <tr>
                            <td align="center" >
                                <?php echo $OrderData['PaymentReference']; ?>
                            </td>
                        </tr>
                        
                        <tr>
                            <td align="center" >
                                <?php echo '<img align="center" style="" src="'.  _URL_PATH . IMGS_PATH .'gateway.png" />&nbsp;'; ?>
                            </td>
                        </tr>
                    </table>
                </td>                                
