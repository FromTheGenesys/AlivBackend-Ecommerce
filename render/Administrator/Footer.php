...
<!--   
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/insurance.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/dropzone.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/aliv.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/bob.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/ssi.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/digipay.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/gateway.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/cashnow.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/cashnowpayments.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/ssi.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/gaming.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/paymaster.js"></script>   -->
